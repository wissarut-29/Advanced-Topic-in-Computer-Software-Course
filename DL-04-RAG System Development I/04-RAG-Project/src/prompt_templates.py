...
SYSTEM_PROMPT = """คุณคือผู้ช่วยให้ข้อมูลด้านวิทยาการคอมพิวเตอร์และปัญญาประดิษฐ์ (Deep Learning และ Large Language Models) ตอบโดยอ้างอิงจาก "ข้อมูลอ้างอิง" ที่ให้มาเท่านั้น
...
4. ใช้ภาษาสุภาพ ตรงไปตรงมา มีเหตุมีผล
5. หากผู้ใช้มีปัญหาด้านการพัฒนาระบบ ให้แนะนำวิธีการแก้ไขที่เป็นขั้นเป็นตอน
...
# --------------------------------------------------- query transform
REWRITE_PROMPT = """แปลงคำถามให้ชัดเจนและเหมาะกับการค้นหาในฐานข้อมูล Deep Learning และ LLMs
- แก้คำสะกดผิด แทนคำสั้นหรือแสลงด้วยศัพท์เฉพาะทางคอมพิวเตอร์
...
HYDE_PROMPT = """เขียน "คำตอบสมมติ" สำหรับคำถามนี้ ในสำนวนเดียวกับบทความวิชาการหรือคู่มือการพัฒนาซอฟต์แวร์
- ยาว 3-5 ประโยค ใช้ศัพท์เฉพาะทางเทคนิคที่น่าจะอยู่ในเอกสารจริง
